...
//Vista para hacer reservaciones
const MenuReserva = () => {
  ...
  const [values, setValues] = useState({
    ...
    cantHoras:1,
    nombreLab:id,
    cedProf:(JSON.parse(localStorage.getItem('data'))).cedula,
    carnetOP:0,
    nombreEstudiante:'',
    aP1Estudiante:'',
    aP2Estudiante:'',
  ...
  const handleUpdate = (event) =>{
    ...
    axios.post('https://localhost:7215/api/Reservacion/crear_reservacion_profesor',values)
    .then(res => {
      console.log(res);
      location.reload();
    })
