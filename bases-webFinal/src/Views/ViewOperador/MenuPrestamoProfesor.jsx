...
//Vista para prestamos de lab a un profesor
const MenuPrestamoProfesor = () =>{
  ...
  const handleUpdate = (event) =>{
    ...
    axios.post('https://localhost:7215/api/Prestamos/crear_prestamo_profesor',values)
    .then(res => {
      console.log(res);
      navigatex('/operador/prestamoprofesores')
    })
    ...
    <div className='d-flex w-100 vh-100 justify-content-center align-items-center bg-light'>
      <div className='w-50 border bg-white shadow px-5 pt-3 pb-5 rounded'>
        ...
        <form onSubmit={handleUpdate}>
          ...
          <div className='mb-2'>
            <label htmlFor='correoEstudiante'>correo profesor</label>
...
export default MenuPrestamoProfesor